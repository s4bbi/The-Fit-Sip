...
const Hero = () => {
  ...
  return (
    <section ref={heroRef} className="w-full bg-white flex flex-col pt-10 pb-12">
      <div className="flex flex-col items-center text-center px-4 sm:px-6 md:px-12">
        ...
        <p className="text-gray-700 text-sm sm:text-base md:text-lg lg:text-xl font-sR max-w-2xl mb-6">
