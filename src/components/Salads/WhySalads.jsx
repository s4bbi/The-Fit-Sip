...
import salads from "../../assets/Images/salad.jpg"; // replace with your actual image
      ...
      <div className="flex flex-col md:flex-row items-center md:items-start justify-between gap-10">
        ...
        <div className="flex-1 text-center md:text-left">
          <h2 className="text-2xl md:text-3xl font-cgEB text-gray-900 mb-4">
            Why our <span className="text-green">Salads?</span>
          </h2>
          <p className="text-gray-700 text-sm sm:text-base md:text-lg font-sR leading-relaxed">
            Our salads are carefully crafted with farm-fresh vegetables, fruits, 
            nuts, and protein for a balanced meal. Packed with vitamins, fiber, 
            and flavor — no preservatives, no compromise. Perfect as a light meal 
