...
import oatsContent from "../../data/oatsContent.js"; // or juicesContent.js
          ...
          >
            ...
            <div className="flex sm:hidden items-center gap-4">
              ...
              <div className="flex flex-col justify-between flex-1">
                ...
                <p className="text-xs text-gray-600 mb-1">{oat.ingredients}</p>
                <p className="text-xs text-gray-500">{oat.calories}</p>

                {/* Price + Button */}
                <div className="flex items-center justify-between mt-2">
                  <span className="font-cgEB text-gray-900">{oat.price}</span>
                  <a
                    href={oat.link}
                    target="_blank"
            ...
            <div className="hidden sm:flex flex-col">
              ...
              />
              <h3 className="font-sB text-lg text-gray-900 mb-1">{oat.title}</h3>
              <p className="text-sm text-gray-600 mb-1">{oat.ingredients}</p>
              <p className="text-sm text-gray-500 mb-2">{oat.calories}</p>

              <div className="flex items-center justify-between mt-4">
                <span className="font-cgEB text-lg text-gray-900">{oat.price}</span>
                <a
                  href={oat.link}
                  target="_blank"
                  rel="noopener noreferrer"
